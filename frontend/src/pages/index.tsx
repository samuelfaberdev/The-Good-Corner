        ...
        <main className="main-content">
          ...
          <section className="recent-ads">
            <div className="ad-card-container">
              <Link className="ad-card-link" href="/Linkds/table">
            ...
            <div className="ad-card-container">
              <Link className="ad-card-link" href="/Linkds/dame-jeanne">
            ...
            <div className="ad-card-container">
              <Link className="ad-card-link" href="/Linkds/vide-poche">
            ...
            <div className="ad-card-container">
              <Link className="ad-card-link" href="/Linkds/vaisselier">
            ...
            <div className="ad-card-container">
              <Link className="ad-card-link" href="/Linkds/bougie">
            ...
            <div className="ad-card-container">
              <Link className="ad-card-link" href="/Linkds/porte-magazine">
                <img
